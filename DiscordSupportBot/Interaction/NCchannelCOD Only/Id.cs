...
using DiscordSupportBot.Interaction.Attribute;
using RequireGuild = DiscordSupportBot.Interaction.Attribute.RequireGuildAttribute;

namespace DiscordSupportBot.Interaction.NC_Guild_Only
{
    [DontAutoRegister]
    [Group("id", "Id")]
#if DEBUG
